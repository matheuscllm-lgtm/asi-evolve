#!/bin/bash
# =============================================================================
# CardTrader vintage FP guard evaluation script for the ASI-Evolve framework.
...
# disabled Microsoft Store stub; `python` is the real interpreter. On Linux both
# exist — prefer python3 there. The evaluator is pure-stdlib, so any Python 3 works.
...
echo "=== CardTrader Vintage Guard Evaluation ===" > "$LOG_FILE"
